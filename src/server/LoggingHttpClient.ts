...
export const loggingHttpClient: Effect.Effect<HttpClient.HttpClient, never, HttpClient.HttpClient> =
  Effect.gen(function* () {
...
export const LoggingHttpClientLayer = Layer.effect(HttpClient.HttpClient, loggingHttpClient);
